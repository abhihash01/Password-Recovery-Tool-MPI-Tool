...
/*int main(){
    ...
    scanf("%s",string);
    //printf("string input taken");
    printf("the output of the string is   \n");
    md5(string,output_buffer);
    printf("here is the output of md5 %s\n",output_buffer);
    sha1(string,output_buffer);
    printf("here is the output of sha1 %s\n",output_buffer);
    sha256(string,output_buffer);
    printf("here is the output of sha256 %s\n",output_buffer);
    sha512(string,output_buffer);
    printf("here is the output of sha512 %s\n",output_buffer);
